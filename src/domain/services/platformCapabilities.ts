    ...
    imageModels: [
      {
        id: 'kling-v1',
        label: 'Kling V1 (通用)',
        description: '快手可灵 · 文生图/图生图',
        capabilities: { t2i: true, i2i: true, stream: false, customSize: false, style: false },
    ...
    imageModels: [
      {
        ...
        label: 'Wanx 2.1 Turbo (快速)',
        description: '阿里万相 · 快速文生图',
        capabilities: { t2i: true, i2i: false, stream: false, customSize: false, style: false },
        supportedAspectRatios: ['1:1', '16:9', '9:16', '4:3', '3:4'],
        maxN: 4,
        recommended: true,
      },
